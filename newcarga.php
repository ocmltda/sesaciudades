...
<br>
   ...
   <div class="myaccount">
      <p class="tituloPresupuesto">Nueva Carga<br>
      </p>
      <p><br>
      </p>
      <form id="form1" name="form1" method="post" action="addcarga.php">
	  <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
		  ...
		  <td>:</td>
		  <td><input name="txtRut" type="text" id="txtRut" size="10" maxlength="9" />
		  -
		  <input name="txtDv" type="text" id="txtDv" size="2" maxlength="1" /></td>
		</tr>
		<tr>
		  <td class="titulosNuestraClinica">Nombre</td>
		  <td>:</td>
		  <td><input name="txtNombre" type="text" id="txtNombre" size="32" maxlength="100" /></td>
		</tr>
		<tr>
		  <td class="titulosNuestraClinica">Ap. Paterno</td>
		  <td>:</td>
		  <td><input name="txtPaterno" type="text" id="txtPaterno" size="32" maxlength="50" /></td>
		</tr>
		<tr>
		  <td class="titulosNuestraClinica">Ap. Materno</td>
		  <td>:</td>
		  <td><input name="txtMaterno" type="text" id="txtMaterno" size="32" maxlength="50" /></td>
		</tr>
		<tr>
		  <td class="titulosNuestraClinica">Fec. Nacimiento</td>
		  <td>:</td>
		  <td><input name="txtFecNac" type="text" id="txtFecNac" size="12" maxlength="10" />
			(dd-mm-aaaa)</td>
		</tr>
		<tr>
		  <td class="titulosNuestraClinica">Email</td>
		  <td>:</td>
		  <td><input name="txtEmail" type="text" id="txtEmail" size="32" maxlength="100" /></td>
		</tr>
		<tr>
		  <td class="titulosNuestraClinica">Sexo</td>
		  <td>:</td>
		  <td><input name="chkSexo" type="radio" id="radio" value="M" checked="checked" />
			Masculino
			<input type="radio" name="chkSexo" id="radio2" value="F" />
			Femenino</td>
		</tr>
		<tr>
		  <td class="titulosNuestraClinica">Teléfono</td>
		  <td>:</td>
		  <td><input name="txtTelefono" type="text" id="txtTelefono" size="16" maxlength="15" /></td>
		</tr>
		<tr>
		  <td class="titulosNuestraClinica">Celular</td>
		  <td>:</td>
		  <td><input name="txtCelular" type="text" id="txtCelular" size="16" maxlength="15" /></td>
		</tr>
		<tr>
		  <td class="titulosNuestraClinica">Parentesco</td>
		  <td>:</td>
		  <td><input name="txtParentesco" type="text" id="txtParentesco" size="32" maxlength="250" /></td>
		</tr>

		<tr>
		  <td class="titulosNuestraClinica">Fec. Inscripción</td>
		  <td>:</td>
		  <td><input name="txtFecInsc" type="text" id="txtFecInsc" size="12" maxlength="10" value="<?php echo date('d-m-Y'); ?>" readonly />        (dd-mm-aaaa)</td>
		</tr>
		<tr>
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>
		...
		<tr>
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>
		  <td><input type="button" name="btnAgregar" id="btnAgregar" value="Agregar" onclick="checkea_form();" /></td>
		</tr>
		<tr>
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>

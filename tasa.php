...
<br>
    ...
    <td align="left" valign="top" bgcolor="#B54515"  style="padding-left:15px;">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><p class="titulosNuestraClinica">SOLICITA TU CREDITO EN SOLUCI&Oacute;N<br>
            ...
            <p></p>
            <p><span class="titulosNuestraClinica">Tasa de Inter&eacute;s</span></p>
      ...
      <script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/credito/tasa"></script>
<!-- InstanceEndEditable -->
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>

...
<!-- #BeginLibraryItem "/Library/Untitled.lbi" --> <span class="titulosNuestraClinica2">Cupones de Descuento</span><br>
      ...
      <table width="100%" border="0" cellspacing="10" cellpadding="10">
        <tr>
          ...
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/americanair.jpg" width="140" height="115" border="0" onClick="MM_openBrWindow('promo40.php','aire','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=350')"></a></td>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/sergio.jpg" width="140" height="115" border="0" onClick="MM_openBrWindow('promo59.php','sergio','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=350')"></a></td>
        </tr>
        <tr>
...
<script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/cupones/r6/automotriz"></script>      

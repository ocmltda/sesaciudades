...
<br>
    ...
    <td align="left" valign="top" bgcolor="#B54515"  style="padding-left:15px;">
      <table width="693" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td bgcolor="#FFFFFF" style="padding:10px;"><!-- InstanceBeginEditable name="Contenido" --><img src="img/sorteo2.jpg" width="551" height="398" border="0" usemap="#Map6" />
        <map name="Map6" id="Map6">
          <area shape="rect" coords="293,327,362,351" href="#" onClick="MM_openBrWindow('bases.php','bases2','scrollbars=yes,width=400,height=500')" />
        </map>
      <br />
      <br />
      <br />

...
<br>
      ...
      <table width="100%" border="0" cellspacing="10" cellpadding="10">
        <tr>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/calzarte.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo10.php','promo10','menubar=yes,scrollbars=yes,resizable=yes,width=240,height=400')"></a></td>
          ...
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/imoto.jpg" width="140" height="115" border="0" onClick="MM_openBrWindow('promo43.php','imoto','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=350')"></a></td>
        </tr>
        <tr>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/teperete.jpg" width="140" height="115" border="0" onClick="MM_openBrWindow('promo60.php','teperete','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=350')"></a></td>
          ...
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/panales-tintin.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo70.php','tintin','menubar=yes,scrollbars=yes,resizable=yes,width=315,height=580')"></a></td>
        </tr>
        <tr>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/viauno.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo73.php','viauno','menubar=yes,scrollbars=yes,resizable=yes,width=240,height=400')"></a></td>
        ...
        <tr>
          ...
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/Eldeseo.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo83.php','deseo','menubar=yes,scrollbars=yes,resizable=yes,width=290,height=470')"></a></td>
...
<script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/cupones/r13/vestuario"></script>

...
<br>
      ...
      <table width="100%" border="0" cellspacing="10" cellpadding="10">
        <tr>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/leon.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo21.php','promo21','menubar=yes,scrollbars=yes,resizable=yes,width=240,height=400')"></a></td>
          ...
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/maxpro.jpg" width="140" height="115" border="0" onClick="MM_openBrWindow('promo56.php','maxpro','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=350')"></a></td>
        </tr>
        <tr>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/rec.jpg" width="140" height="115" border="0" onClick="MM_openBrWindow('promo57.php','recdesar','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=350')"></a></td>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/fortaleza.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo64.php','fortaleza','menubar=yes,scrollbars=yes,resizable=yes,width=290,height=460')"></a></td>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/serrano.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo71.php','serrano','menubar=yes,scrollbars=yes,resizable=yes,width=240,height=400')"></a></td>
        </tr>
        <tr>
      ...
      <br /><script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/cupones/r13/automotriz"></script>

...
$sub="SOLICITA TU CREDITO EN SOLUCIÓN";

$mensaje=":: SOLICITA TU CREDITO EN SOLUCIÓN" . chr(13). chr(10);
...
$mensaje=$mensaje . "Monto: " . $_POST[monto]        . chr(13). chr(10);

$mensaje=$mensaje . "Plazo: " . $_POST[plazo]        . chr(13). chr(10);
 
 
}

      mail(" info@beneficioschile.cl", $sub, $mensaje, $headers);
...
$sub2="SOLICITA TU CREDITO EN SOLUCIÓN " . chr(13). chr(10);

$mensaje2= "Estimado Socio / a  $_POST[nombre] 
Hemos recibido tu solicitud. Le responderemos a la brevedad posible.
Saludos Cordiales 
Beneficios Chile

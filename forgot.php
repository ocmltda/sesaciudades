      ...
      <table width="693" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <p>
            ...
            <span class="titulosNuestraClinica2">&iquest;OLVID&Oacute; SU CONTRASE&Ntilde;A?<br>
            </span><br>
            <span class="texto">SINO TE ACUERDAS DE TU CLAVE, FAVOR DE LLAMARNOS AL TEL&Eacute;FONO 02-22250576, &nbsp;Y LA SRTA. NICOLE&nbsp;PODR&Aacute; AYUDARTE O ENV&Iacute;ANOS UN MAIL CON TUS DATOS A</span>&nbsp;<a href="mailto:info@beneficioschile.cl" target="_blank">info@beneficioschile.cl</a>&nbsp;&nbsp;&nbsp;<br>
            <br />
          </p>
          <!-- InstanceEndEditable -->
            <table width="100%" border="0" cellspacing="0" cellpadding="0">

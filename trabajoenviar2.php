      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><p class="titulosNuestraClinica">TRABAJA EN ECR GROUP<br>
            <br>
            Su curriculum ha sido enviado exitosamente. Muchas Gracias.
<br>
          </p>
         <?php 
function form_mail($sPara, $sAsunto, $sTexto, $sDe)
{ 
$sAsunto ="Postulacion Trabajo ECR Group";
$sDe ="info@beneficioschile.cl";
$bHayFicheros = 0; 
$sCabeceraTexto = ""; 
$sAdjuntos = ""; 
...
if (form_mail("mvillarino@ecrgroup.cl,  ndelabarra@ecrgroup.cl", $_POST[asunto], 
"Los datos introducidos en el formulario de postulacion son:\n\n", $_POST[email])) 

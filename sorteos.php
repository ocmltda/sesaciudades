...
<br>
    ...
    <td align="left" valign="top" bgcolor="#B54515"  style="padding-left:15px;">
      ...
      <h2 class="titulosNuestraClinica2">Concursos y Promociones Vigentes</h2>
      <p>&nbsp;</p>
      <table width="100%" border="0">
        <tr>
          <td align="center"><span class="titulosNuestraClinica">PRONTO M&Aacute;S SORTEOS Y CONCURSOS<br>
            &iexcl;VISITANOS FRECUENTEMENTE!
          </span><a href="sorteoganador.php"><br>
            <br>
<br>
            <br>
          <img src="img/sorteos.jpg" width="506" height="75" border="0" /></a>

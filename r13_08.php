...
<br>
      ...
      <table width="100%" border="0" cellspacing="10" cellpadding="10">
        <tr>
          ...
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/granjaeducativa.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo65.php','granja','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=400')"></a></td>
        </tr>
        <tr>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/yukids.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo82.php','yukids','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=400')"></a></td>
      ...
      <br /><script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/cupones/r13/diversion"></script>

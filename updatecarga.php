<?php
	...
	if (isset($_SESSION['xmlSession']) && isset($_SESSION['rut']) && isset($_SESSION['dv']))
	{
		...
		if (!isset($xml->error))
		{
			...
			{
				if ($val->rutCarga == trim($_GET['rut']))
				{
					$vrut = $val->rutCarga . '';
					$vnombre = $val->nombre . '';
					$vappaterno= $val->paterno . '';
					$vapmaterno = $val->materno . '';
					$fecnacimiento = $val->fecNacimiento;
					$vfecnacimiento = substr($fecnacimiento, 6, 2) . '-' . substr($fecnacimiento, 4, 2) . '-' . substr($fecnacimiento, 0, 4);
					$vemail = $val->email . '';
					...
					$vtelefono = $val->telefono . '';
					$vcelular = $val->celular . '';
					$vparentesco = $val->parentesco . '';
					$fecinscripcion = $val->fecInscripcion;
					$vfecinscripcion = substr($fecinscripcion, 6, 2) . '-' . substr($fecinscripcion, 4, 2) . '-' . substr($fecinscripcion, 0, 4);
				}
			}
		}
		else
...
<script language="JavaScript" type="text/javascript" src="include/rutinas.js"></script>
<!-- InstanceEndEditable -->
...
<br>
   ...
   <div class="myaccount">
      <p class="tituloPresupuesto">Modificar Carga<br>
      </p>
      <p><br>
      </p>
      <form id="form1" name="form1" method="post" action="updcarga.php">
	  <input name="rut" type="hidden" id="rut" value="<?php echo $vrut; ?>" />
	  <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
		  <td class="titulosNuestraClinica">Rut</td>
		  <td>:</td>
		  <td><?php echo $vrut; ?></td>
		</tr>
		<tr>
		  <td class="titulosNuestraClinica">Nombre</td>
		  <td>:</td>
		  <td><input name="txtNombre" type="text" id="txtNombre" value="<?php echo $vnombre; ?>" size="32" maxlength="100" /></td>
		</tr>
		<tr>
		  <td class="titulosNuestraClinica">Ap. Paterno</td>
		  <td>:</td>
		  <td><input name="txtPaterno" type="text" id="txtPaterno" value="<?php echo $vappaterno; ?>" size="32" maxlength="50" /></td>
		</tr>
		<tr>
		  <td class="titulosNuestraClinica">Ap. Materno</td>
		  <td>:</td>
		  <td><input name="txtMaterno" type="text" id="txtMaterno" value="<?php echo $vapmaterno; ?>" size="32" maxlength="50" /></td>
		</tr>
		<tr>
		  <td class="titulosNuestraClinica">Fec. Nacimiento</td>
		  <td>:</td>
		  <td><input name="txtFecNac" type="text" id="txtFecNac" value="<?php echo $vfecnacimiento; ?>" size="12" maxlength="10" />
		  (dd-mm-aaaa)</td>
		</tr>
		<tr>
		  <td class="titulosNuestraClinica">Email</td>
		  <td>:</td>
		  <td><input name="txtEmail" type="text" id="txtEmail" value="<?php echo $vemail; ?>" size="32" maxlength="100" /></td>
		</tr>
		<tr>
		  <td class="titulosNuestraClinica">Sexo</td>
		  <td>:</td>
		  <td><input name="chkSexo" type="radio" id="radio" value="M" <?php if (isset($checkedM)) echo $checkedM; ?> />
			Masculino
			<input type="radio" name="chkSexo" id="radio2" value="F" <?php if (isset($checkedF)) echo $checkedF; ?> />
			Femenino</td>
		</tr>
		<tr>
		  <td class="titulosNuestraClinica">Teléfono</td>
		  <td>:</td>
		  <td><input name="txtTelefono" type="text" id="txtTelefono" value="<?php echo $vtelefono; ?>" size="16" maxlength="15" /></td>
		</tr>
		<tr>
		  <td class="titulosNuestraClinica">Celular</td>
		  <td>:</td>
		  <td><input name="txtCelular" type="text" id="txtCelular" value="<?php echo $vcelular; ?>" size="16" maxlength="15" /></td>
		</tr>
		<tr>
		  <td class="titulosNuestraClinica">Parentesco</td>
		  <td>:</td>
		  <td><input name="txtParentesco" type="text" id="txtParentesco" value="<?php echo $vparentesco; ?>" size="32" maxlength="50" /></td>
		</tr>
		<tr>
		  <td class="titulosNuestraClinica">Fec. Inscripción</td>
		  <td>:</td>
		  <td><input name="txtFecInsc" type="text" id="txtFecInsc" value="<?php echo $vfecinscripcion; ?>" size="12" maxlength="10" readonly />
		  (dd-mm-aaaa)</td>
		</tr>
		<tr>
		  <td>&nbsp;</td>
		...
		<tr>
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>
		  <td><input type="button" name="btnModificar" id="btnModificar" value="Modificar" onclick="checkea_form_update();" /></td>
		</tr>
		<tr>
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>

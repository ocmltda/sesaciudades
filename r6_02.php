...
<!-- #EndLibraryItem --></p>
      <table width="100%" border="0" cellspacing="10" cellpadding="10">
        <tr>
          <td width="33%" height="138" align="center" valign="middle"><a href="#"><img src="img/cupones/anamaria.jpg" width="140" height="115" border="0" onClick="MM_openBrWindow('promo62.php','anamaria','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=350')"></a></td>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/pacificClub.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('img/cupones/PacificClub.html','pacific','menubar=yes,scrollbars=yes,resizable=yes,width=650,height=350')"></a></td>
      ...
      <br />
   <script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/cupones/r6/deporte"></script>    

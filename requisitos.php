...
<br>
    ...
    <td align="left" valign="top" bgcolor="#B54515"  style="padding-left:15px;">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><p class="titulosNuestraClinica">SOLICITA TU CREDITO EN SOLUCI&Oacute;N<br>
            ...
            <p class="titulosNuestraClinica">&nbsp;</p>
            <p><span class="titulosNuestraClinica">                REQUISITOS DEL TRABAJADOR</span><span class="texto"><br>
                  Ser trabajador de una empresa del grupo ECR Group o Empresas Relacionadas.<br>
                  Antiguedad Laboral mayor a 6 meses.<br>
                  Tener contrato de trabajo (Indefinido).<br>
                  Ser mayor de 18 a&ntilde;os.<br>
                  C&eacute;dula de identidad vigente.<br>
                  Para adquirir un cr&eacute;dito debe calificar con la pauta de cr&eacute;dito.</span></p>
            <p><span class="texto"><br>
              En los casos que se requiera la presentaci&oacute;n de avales para su solicitud de cr&eacute;dito, deber&aacute;n cumplir con el requisito de ser trabajadores de alguna empresa del grupo ECR Group o Empresas Relacionadas.<br>
              <br>
              </span><span class="titulosNuestraClinica">DOCUMENTOS NECESARIOS</span><span class="texto"><br>
                <br>
                La documentaci&oacute;n que deber&aacute; presentar para solicitar y suscribir un Cr&eacute;dito Soluci&oacute;n es la siguiente:</span></p>
            <p><span class="texto"><br>
              Tres &uacute;ltimas liquidaciones (renta fija y variable) (solicitante y avales cuando corresponda).<br>
              Fotocopia de c&eacute;dula de identidad vigente (solicitante y avales).<br>
              Pagar&eacute;, en el cual debe consignarse solo la firma y huella digital del solicitante y sus avales.<br>
              Mandato de cargo de cuota en Liquidaci&oacute;n de Sueldo.</span></p>
            <p><span class="texto"><br>
              Esta documentaci&oacute;n debe ser presentada en cualquiera de nuestras oficinas a lo largo del pa&iacute;s.</span></p>
            <p><span class="texto"><br>
                <em>Nota: En casos particulares Soluci&oacute;n se reserva el derecho de solicitar requisitos y/o documentos adicionales.</em></span><br>
              <br>
            </p></td>
        </tr>
        </table>
      ...
      <script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/credito/requisitos"></script>
<!-- InstanceEndEditable -->
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>

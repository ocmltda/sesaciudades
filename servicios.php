...
<br>
    ...
    <td align="left" valign="top" bgcolor="#B54515"  style="padding-left:15px;">
      ...
      <p><span class="titulosNuestraClinica2">SERVICIOS</span><br />
      </p>
      <p>&nbsp;</p>
      <div id="Accordion1" class="Accordion" tabindex="0">
        <div class="AccordionPanel">
          <div class="AccordionPanelTab">Enfermeras</div>
          <div class="AccordionPanelContent"><span class="titulosNuestraClinica"><br>
            - 
            Karen Quezada Mar&iacute;n, Enfermera Universitaria.<br>
            Servicios: Instalacaion y mantenci&oacute;n de V&iacute;a venosa Perif&eacute;rica, Sonda Foley, Curaciones Avanzadas, Tratamiento Endovenoso.<br>
            Telefono de contacto para Consultas: Fijo: 934 40 70 / Movil: 9-790 8806<br>
            <br>
-            SALUD M&Aacute;S HOGAR<br>
www.saludmashogar.cl <br>
Tel.02-7481099 <br>
Cel 7-6317824 / 7-4675750</span></div></div>
        <div class="AccordionPanel">
          <div class="AccordionPanelTab">Peluquer&iacute;a</div>
          <div class="AccordionPanelContent">
            <p class="titulosNuestraClinica"><br>
              PELUQUER&Iacute;A MB<br>
            Mariela Bastias y C&iacute;a. Ltda</p>
            <p class="titulosNuestraClinica">Direcci&oacute;n : Chacabuco 218, comuna Maip&uacute;</p>
          </div>
        </div>
        <div class="AccordionPanel">
          <div class="AccordionPanelTab">Belleza</div>
          <div class="AccordionPanelContent">
            <p><br>
              <span class="titulosNuestraClinica">Sal&oacute;n de Belleza Francia<br>
              Direcci&oacute;n :  Ahumada 131 Local 13, Comuna de Santiago centro</span></p>
            <p>&nbsp;</p>
            <p><span class="titulosNuestraClinica">Pretty Woman - Empres Intenacional de Est&eacute;tica Integral<br>
              Fonos 7628103-7625477
              </span>- <a href="#" onClick="MM_openBrWindow('promo10b.php','promo10b','menubar=yes,scrollbars=yes,resizable=yes,width=310,height=480')"><span class="titulosNuestraClinica">Direcciones Pinche Aqui</span></a><br>
            </p>
          </div></div>
        <div class="AccordionPanel">
          <div class="AccordionPanelTab">Spa</div>
          <div class="AccordionPanelContent"><span class="titulosNuestraClinica"><br>
            URBANO DAYSPA<br>
Augustinas 1022, Of 1015<br>
Tel 6969964 - 6983924<br>
www.udspa.cl </span></div></div>
      </div>
      <p><br />
...
<!--
    ...
    tagCertifica( 25780, '/home/beneficios/servicios');

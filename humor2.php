...
<br>
    ...
    <td align="left" valign="top" bgcolor="#B54515"  style="padding-left:15px;">
      ...
      <p class="txt"><span class="titulosNuestraClinica2">Env&iacute;anos un chiste</span><br>
        <br>
        </p>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="71%" class="sesasegerenci"><table width="80%" 
            ...
            <tbody>
              <tr valign="top">
                <td width="100%" ><form id="contact-form2" method="post" onSubmit="return emailCheck(this.email.value);" action="emailhumor.php">
                  <div>
                    <table width="100%" border="00s" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td valign="top" class="texto" style=" padding-top:5px"><strong>Escribe Aqu&iacute; tu chiste<span style="color: #CC0000">(*)</span></strong></td>
                        <td>&nbsp;</td>
...
<input name="submit" type="submit" id="submit2" title="Pulsa una vez para enviar el mensaje, y espera a la pantalla de confirmaci&Atilde;&sup3;n" onClick="MM_validateForm('nombre','','R','email','','NisEmail','text','','R');return document.MM_returnValue" value="Enviar &raquo;" />
                    </pre>
                    </div>
      ...
      <script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/humor/enviar"></script>

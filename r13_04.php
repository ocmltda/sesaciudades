...
<!-- #EndLibraryItem --></p>
      <table width="99%" border="0" cellspacing="10" cellpadding="10">
        <tr>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/drPet.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo75.php','drpet','menubar=yes,scrollbars=yes,resizable=yes,width=240,height=400')"></a></td>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/PetStore.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo84.php','petstore','menubar=yes,scrollbars=yes,resizable=yes,width=240,height=400')"></a></td>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/AlLmedicalVvet.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo87.php','allmedical','menubar=yes,scrollbars=yes,resizable=yes,width=280,height=510')"></a></td>
        </tr>
        <tr>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/MrPetChile.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo86.php','chile','menubar=yes,scrollbars=yes,resizable=yes,width=240,height=400')"></a></td>
      ...
      <br /><script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/cupones/r13/mascota"></script>

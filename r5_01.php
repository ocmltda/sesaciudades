...
<br>
      ...
      <table width="100%" border="0" cellspacing="10" cellpadding="10">
        <tr>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/bellaindia.jpg" width="140" height="115" border="0" onClick="MM_openBrWindow('promo39.php','bella','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=350')"></a></td>
          ...
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/perfumesDevia.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo79.php','devia','menubar=yes,scrollbars=yes,resizable=yes,width=315,height=580')"></a></td>
        </tr>
        <tr>
...
<script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/cupones/r5/vestuario"></script>
    <!-- InstanceEndEditable -->
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>

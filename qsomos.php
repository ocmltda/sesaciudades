...
<br>
    ...
    <td align="left" valign="top" bgcolor="#B54515"  style="padding-left:15px;">
      <table width="693" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td bgcolor="#FFFFFF" style="padding:10px;"><!-- InstanceBeginEditable name="Contenido" --><span class="titulosNuestraClinica2">Quienes Somos 

          </span><span class="txt"><br />
          <br />
          </span>
<p class="texto">Somos <span class="titulosNuestraClinica">BENEFICIOS CHILE, UNA EMPRESA PERTENECIENTE AL HOLDING ECR GROUP ,FUNDADA EL A&Ntilde;O 2007    </span>que hemos implementado un Club de Beneficios especialmente dise&ntilde;ado para ti y para toda tu familia. </p>
<p class="texto">&nbsp;</p>
          <p class="texto">Esperamos retribuir tu preferencia y encantarte con un mundo de beneficios, promociones, sorpresas y mucho m&aacute;s, queremos estrechar nuestra relaci&oacute;n contigo y tu grupo familiar siempre.</p>
          <p class="texto">&nbsp;</p>
          <p class="texto"><span class="titulosNuestraClinica">BENEFICIOS CHILE </span>ir&aacute; entregando en el tiempo cada vez m&aacute;s y mejores beneficios, esperamos contar con tu participaci&oacute;n y tu opini&oacute;n permanente, dado que <span class="titulosNuestraClinica">BENEFICIOS CHILE</span> se creo pensando en ti y tu<span class="titulosNuestraClinica"> ENTORNO</span> familiar. </p>
          <p class="texto">&nbsp;</p>
          <p class="texto"><span class="titulosNuestraClinica">BENEFICIOS CHILE </span>opera s&oacute;lo a trav&eacute;s de nuestra p&aacute;gina, tanto los beneficios, sorteos, promociones, canalizada a trav&eacute;s de este canal digital.</p>
          <p class="texto">&nbsp;</p>
          <p class="texto">Para integrarte debes registrarte tu y a tu grupo familiar ( no es obligatorio inscribir a todo el grupo familiar, pero si tienes inscrito a tu grupo familiar m&aacute;s posibilidades tienen de ganar en los diferentes sorteos y promociones que se realicen ) a trav&eacute;s de llenar un peque&ntilde;o formulario en Informaciones al interior de <span class="titulosNuestraClinica">BENEFICIOS CHILE </span>o a trav&eacute;s de nuestra p&aacute;gina y seleccionas &quot;Reg&iacute;strate en <span class="titulosNuestraClinica">BENEFICIOS CHILE </span>&quot;, llenar los datos solicitados y &quot; Enviar&quot; , luego asistir a Informaciones al interior de <span class="titulosNuestraClinica">BENEFICIOS CHILE</span> y solicitar tu tarjeta de socio y las tarjetas correspondientes a las personas que inscribiste de tu grupo familiar, no puedes retirar las tarjetas de otras personas inscritas.</p>
          <p class="texto">&nbsp;</p>
          <p><span class="texto">Importante informar que la administraci&oacute;n de </span><span class="titulosNuestraClinica">BENEFICIOS CHILE</span><span class="texto"> es de responsabilidad de Servicios Electr&oacute;nicos S.A. </span></p>
          <p><span class="texto"><br>
            Contactare con nosotros al fono 02 2225 0576 o al correo <a href="mailto:info@beneficioschile.cl">info@beneficioschile.cl</a></span><br>
          </p>
          <br />
      <br /><script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/qsomos"></script>
          <!-- InstanceEndEditable -->
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>

...
$sub="CONVENIO REGIONES BENEFICIOS CHILE";

$mensaje=":: CONVENIO REGIONES BENEFICIOS CHILE " . chr(13). chr(10);
...
$mensaje=$mensaje . "Empresa a contactar " . $_POST[empresa1]        . chr(13). chr(10);

$mensaje=$mensaje . "Nombre de contacto empresa " . $_POST[empresa2]        . chr(13). chr(10);

$mensaje=$mensaje . "Giro " . $_POST[giro]        . chr(13). chr(10);

...
<br>
      ...
      <table width="100%" border="0" cellspacing="10" cellpadding="10">
        <tr>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/salcobrand.jpg" width="140" height="115" border="0" onClick="MM_openBrWindow('promo26.php','salcobrand','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=350')"></a></td>
          <td width="33%" align="center" valign="middle"><img src="img/cupones/help.jpg" width="140" height="115" onClick="MM_openBrWindow('promo36.php','help','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=350')"></td>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/cimek.jpg" width="140" height="115" border="0" onClick="MM_openBrWindow('promo37.php','cimek','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=350')"></a></td>
        </tr>
        <tr>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/clinicacentral.jpg" width="140" height="115" border="0" onClick="MM_openBrWindow('promo38.php','central','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=350')"></a></td>
...
<br />
  <script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/cupones/r6/salud"></script>     

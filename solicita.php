...
<br>
    ...
    <td align="left" valign="top" bgcolor="#B54515"  style="padding-left:15px;">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="center" valign="top"><br>
            <table width="70%" border="0" cellpadding="0" cellspacing="0" class="fondoSugerencias">
              <tr>
                <td width="45%" align="center" class="titulosNuestraClinica">Ingresa tu Monto ($)</td>
                <td height="40" align="center"><input name="textfield" type="text" class="titulosNuestraClinica" id="textfield" size="40"></td>
              </tr>
              <tr>
                <td align="center" class="titulosNuestraClinica">Selecciona el N&uacute;mero de Cuotas</td>
                <td height="40" align="center"><label for="select"></label>
              ...
              <tr>
                <td align="center">&nbsp;</td>
                <td height="40" align="center"><input type="submit" name="button" id="button" value="Calcular"></td>
              </tr>
            </table>
            <br>
            <br></td>
      ...
      <p><br />
        <br />       
      </p>      <script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/credito"></script>
    <!-- InstanceEndEditable -->
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>

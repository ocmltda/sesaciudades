...
<br>
    ...
    <td align="left" valign="top" bgcolor="#B54515"  style="padding-left:15px;">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="left" valign="top"><p class="titulosNuestraClinica">&nbsp;</p>
<p class="tituloPresupuesto">P&Aacute;GINA EN CONSTRUCCI&Oacute;N</p>
            <p><br>
              <br>
            </p></td>
          </tr>
      ...
      <p>&nbsp;</p>
      <p><br />
        <br />       <script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/simula"></script>
      </p>
    <!-- InstanceEndEditable -->
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>

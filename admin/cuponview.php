...
<?php } ?>
<?php if ($Security->IsLoggedIn()) { ?>
<a href="cupon_categlist.php?<?php echo EW_TABLE_SHOW_MASTER ?>=cupon&cup_id=<?php echo urlencode(strval($cupon->cup_id->CurrentValue)) ?>"><?php echo $Language->Phrase("ViewPageDetailLink") ?><?php echo $Language->TablePhrase("cupon_categ", "TblCaption") ?>
</a>
&nbsp;
<?php } ?>
<?php if ($Security->IsLoggedIn()) { ?>
<a href="cupon_regionlist.php?<?php echo EW_TABLE_SHOW_MASTER ?>=cupon&cup_id=<?php echo urlencode(strval($cupon->cup_id->CurrentValue)) ?>"><?php echo $Language->Phrase("ViewPageDetailLink") ?><?php echo $Language->TablePhrase("cupon_region", "TblCaption") ?>
</a>
&nbsp;
<?php } ?>
<?php } ?>

...
<?php if ($local->loc_comuna->Visible) { // loc_comuna ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $local->SortUrl($local->loc_comuna) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $local->loc_comuna->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($local->loc_comuna->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($local->loc_comuna->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($local->loc_ciudad->Visible) { // loc_ciudad ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $local->SortUrl($local->loc_ciudad) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $local->loc_ciudad->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($local->loc_ciudad->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($local->loc_ciudad->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php
...
class clocal_list {
	...
	function BasicSearchSQL($Keyword) {
		...
		$this->BuildBasicSearchSQL($sWhere, $local->loc_comuna, $Keyword);
		$this->BuildBasicSearchSQL($sWhere, $local->loc_ciudad, $Keyword);
		return $sWhere;
	}
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$local->UpdateSort($local->loc_comuna); // loc_comuna
			$local->UpdateSort($local->loc_ciudad); // loc_ciudad
	...
	function ResetCmd() {
		...
		if (@$_GET["cmd"] <> "") {
			...
			if (strtolower($sCmd) == "resetsort") {
				...
				$local->loc_comuna->setSort("");
				$local->loc_ciudad->setSort("");
			}

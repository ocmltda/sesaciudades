...
class clocal_add {
	...
	function LoadDefaultValues() {
		...
		$local->loc_comuna->CurrentValue = NULL;
		$local->loc_comuna->OldValue = $local->loc_comuna->CurrentValue;
		$local->loc_ciudad->CurrentValue = NULL;
		$local->loc_ciudad->OldValue = $local->loc_ciudad->CurrentValue;
	}

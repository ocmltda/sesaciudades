...
local_grid.EmptyRow = function(fobj, infix) {
	if (ew_ValueChanged(fobj, infix, "com_id", false)) return false;
...
<?php if ($local->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<select id="x<?php echo $local_grid->RowIndex ?>_com_id" name="x<?php echo $local_grid->RowIndex ?>_com_id"<?php echo $local->com_id->EditAttributes() ?>>
<?php
...
if (@$emptywrk) $local->com_id->OldValue = "";
?>
</select>
<input type="hidden" name="o<?php echo $local_grid->RowIndex ?>_com_id" id="o<?php echo $local_grid->RowIndex ?>_com_id" value="<?php echo ew_HtmlEncode($local->com_id->OldValue) ?>">
<?php } ?>
<?php if ($local->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<select id="x<?php echo $local_grid->RowIndex ?>_com_id" name="x<?php echo $local_grid->RowIndex ?>_com_id"<?php echo $local->com_id->EditAttributes() ?>>
<?php
...
<input type="hidden" name="x<?php echo $local_grid->RowIndex ?>_com_id" id="x<?php echo $local_grid->RowIndex ?>_com_id" value="<?php echo ew_HtmlEncode($local->com_id->CurrentValue) ?>">
<input type="hidden" name="o<?php echo $local_grid->RowIndex ?>_com_id" id="o<?php echo $local_grid->RowIndex ?>_com_id" value="<?php echo ew_HtmlEncode($local->com_id->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>

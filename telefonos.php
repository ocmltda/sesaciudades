...
<br>
    ...
    <td align="left" valign="top" bgcolor="#B54515"  style="padding-left:15px;">
      ...
      <p class="txt"><span class="titulosNuestraClinica2">CONTACTO</span><br>
        <br>
        Ll&aacute;manos al 56 (2) 2225-0576,&nbsp;o&nbsp;env&iacute;anos tus datos a&nbsp;<a href="mailto:info@beneficioschile.cl" target="_blank">info@beneficioschile.cl</a></p>
<p class="txt"><br /><script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/telefono"></script>
</p>
    <!-- InstanceEndEditable -->
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>

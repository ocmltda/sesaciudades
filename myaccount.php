<?php
	...
	if (isset($_SESSION['xmlSession']) && isset($_SESSION['rut']) && isset($_SESSION['dv']))
	{
		...
		if (!isset($xml->error))
		{
			$username = $xml->nombre . ' ' . $xml->paterno;
		}
		else
		{
...
<br>
   ...
   <div class="myaccount">
      <p class="tituloPresupuesto">Bienvenido <?php echo $username; ?><br>
      </p>
      <p><br>
      </p>
      <table width="60%" border="0" align="center" cellpadding="0" cellspacing="0" class="form">
        <tr>
          <td width="23%" height="15" align="right" valign="middle"><a href="mysettings.php"><img src="img/book.png" width="25" height="24" border="0"></a></td>
          <td  style="padding-left:20px;"width="77%" align="left" valign="middle"><a href="mysettings.php">VER MIS DATOS / CREAR CREDENCIAL DIGITAL</a></td>
          </tr>
        <tr>
          <td width="23%" height="7" align="right" valign="middle"><img src="img/coupon_icon.png" width="35" height="30"></td>
          <td  style="padding-left:20px;" align="left" valign="middle"><a href="cupones.php">VER CUPONES</a></td>
        </tr>
        <tr>
          <td width="23%" height="7" align="right" valign="middle"><img src="img/currency_dollar_red.png" width="25" height="25"></td>
          <td  style="padding-left:20px;" align="left" valign="middle"><a href="promo.php">VER PROMOCIONES</a></td>
        </tr>
		<tr>
          <td width="23%" height="29" align="right" valign="middle"><a href="cargas.php"><img src="img/familia.png" width="25" height="24" border="0"></a></td>
          <td  style="padding-left:20px;"width="77%" align="left" valign="middle"><a href="cargas.php">ADMINISTRAR MIS CARGAS</a></td>
          </tr>
        <tr>
          <td width="23%" align="right" valign="middle"><a href="logout.php"><img src="img/button_cerrar-18f8ec6.png" width="24" height="24" border="0"></a></td>
          <td  style="padding-left:20px;" width="77%" align="left" valign="middle"><a href="logout.php">CERRAR SESI&Oacute;N</a></td>
          </tr>
      </table>
      <p>&nbsp;</p>
    <p>&nbsp;</p></div>	  <?php	

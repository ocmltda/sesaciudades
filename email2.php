...
$sub="Sugerencias Club SESA";

$mensaje=":: Sugerencias Club SESA " . chr(13). chr(10);
$mensaje=$mensaje . "--------------------------------------------------------------------" . chr(13). chr(13). chr(10);
$mensaje=$mensaje . "SUGERENCIAS Y OPINIONES" . chr(13). chr(13). chr(10);
$mensaje=$mensaje . "--------------------------------------------------------------------" . chr(13). chr(13). chr(10);
...
$mensaje=$mensaje . "Comentarios: " . $_POST[text]      . chr(13). chr(10);
      ...
      mail("gvillarino@sesa.cl, dguevara@sesa.cl", $sub, $mensaje, $headers);
...
$sub2=":: Desde sesa.cl :: Sugerencias " . chr(13). chr(10);

$mensaje2= "Club SESA le informa que su formulario de sugerencias ha sido recibido de forma exitosa. Muchas Gracias. " . chr(13). chr(13). chr(10);
$headers2= "From: club@sesa.cl\r\n" . "Reply-To: chp@chp.cl\r\n" . "Return-path: club@sesa.cl\r\n" . "MIME-Version: 1.0\n" . "Content-type: text/plain; charset=iso-8859-1"; 

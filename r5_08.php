...
<br>
      ...
      <table width="100%" border="0" cellspacing="10" cellpadding="10">
        <tr>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/hotelronda.jpg" width="140" height="115" border="0" onClick="MM_openBrWindow('promo18.php','hotel','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=350')"></a></td>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/cAguasMarinas.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo74.php','aguasmarina','menubar=yes,scrollbars=yes,resizable=yes,width=280,height=460')"></a></td>
...
<script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/cupones/r5/diversion"></script>
    <!-- InstanceEndEditable -->
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>

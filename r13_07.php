...
<br>
      ...
      <table width="100%" border="0" cellspacing="10" cellpadding="10">
        <tr>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/bebesit.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo28.php','promo28','menubar=yes,scrollbars=yes,resizable=yes,width=250,height=400')"></a></td>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/piumino.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo7.php','piumino','menubar=yes,scrollbars=yes,resizable=yes,width=240,height=400')"></a></td>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/pellitos.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo6.php','pellito','menubar=yes,scrollbars=yes,resizable=yes,width=240,height=400')"></a></td>
        </tr>
        <tr>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/outletbebe.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo5.php','outbebe','menubar=yes,scrollbars=yes,resizable=yes,width=240,height=400')"></a></td>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/claro.jpg" width="140" height="115" border="0" onClick="MM_openBrWindow('promo42.php','claro','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=350')"></a></td>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/mundobebe.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo68.php','mundobebe','menubar=yes,scrollbars=yes,resizable=yes,width=250,height=400')"></a></td>
        </tr>
        <tr>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/lacasa-delbeb&eacute;.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo89.php','bebecasa','menubar=yes,scrollbars=yes,resizable=yes,width=240,height=400')"></a></td>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/manzanitabeb&eacute;.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo90.php','manzanita','menubar=yes,scrollbars=yes,resizable=yes,width=240,height=400')"></a></td>
      ...
      <br />
       <script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/cupones/r13/hogar"></script>

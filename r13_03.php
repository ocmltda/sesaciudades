...
<br>
      ...
      <table width="100%" border="0" cellspacing="10" cellpadding="10">
        <tr>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/chinawok.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo2.php','prmo2','menubar=yes,scrollbars=yes,resizable=yes,width=240,height=400')"></a></td>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/fritz.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo76.php','fritz','menubar=yes,scrollbars=yes,resizable=yes,width=240,height=400')"></a></td>
          <td width="33%" align="center" valign="middle"><a href="img/cupones/pizzapizza2.pdf" target="_new"><img src="img/cupones/pizza-pizza-helado.jpg" width="140" height="116" border="0"></a></td>
        </tr>
        <tr>
          <td align="center" valign="middle"><a href="img/cupones/pizzapizza1.pdf" target="_new"><img src="img/cupones/pizza-pizza-bebida.jpg" width="140" height="116" border="0"></a></td>
...
<script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/cupones/r13/restaurant"></script>      

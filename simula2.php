...
<br>
    ...
    <td align="left" valign="top" bgcolor="#B54515"  style="padding-left:15px;">
      ...
      <p><span class="titulosNuestraClinica2">SIMULA TU CR&Eacute;DITO</span><br>
      </p>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="left" valign="top"><p class="titulosNuestraClinica"> PARA QUE TU FIN DE A&Ntilde;O SEA INOLVIDABLE </p>
            <p class="texto">&nbsp;Valor Cuota Incluye Impuestos y gastos notariales. </p>
            <p><br>
            <br>
            </p></td>
          </tr>
        <tr>
          <td align="center" valign="top"><table width="85%" border="0" cellpadding="0" cellspacing="0" class="fondoSugerencias">
            <tr>
              <td width="45%" align="center" class="titulosNuestraClinica">Nombre:</td>
              <td height="40" align="left"><input name="textfield3" type="text" class="titulosNuestraClinica" id="textfield3" size="40"></td>
            </tr>
            <tr>
              <td align="center" class="titulosNuestraClinica">Rut:</td>
              <td height="40" align="left"><input name="textfield2" type="text" class="titulosNuestraClinica" id="textfield2" size="40"></td>
            </tr>
            <tr>
              <td width="45%" align="center" class="titulosNuestraClinica">Ingresa tu Monto ($)</td>
              <td height="40" align="left"><input name="textfield" type="text" class="titulosNuestraClinica" id="textfield" size="40"></td>
            </tr>
            <tr>
              <td align="center" class="titulosNuestraClinica">Selecciona el N&uacute;mero de Cuotas</td>
              <td height="40" align="left"><label for="select"></label>
                <select name="select" class="titulosNuestraClinica" id="select">
                  <option>2</option>
                  <option>4</option>
                  <option>6</option>
                  <option>8</option>
            ...
            <tr>
              ...
              <td height="40" align="left"><input type="submit" name="button" id="button" value="Calcular Cuota"> </td>
            </tr>
            <tr>
              <td height="40" align="left"><a href="credito.php"><img src="img/solcredito.jpg" width="111" height="25" border="0"></a></td>
            </tr>
          </table></td>
        </tr>
      </table>
...
<!--
    ...
    tagCertifica( 25780, '/home/beneficios/opinion');

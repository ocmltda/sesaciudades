...
<!-- #EndLibraryItem --></p>
      <table width="100%" border="0" cellspacing="10" cellpadding="10">
        <tr>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/botaverde.jpg" width="140" height="115" border="0" onClick="MM_openBrWindow('promo52.php','botaverde','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=350')"></a></td>
      ...
      <br />
    <script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/cupones/r7/vestuario"></script>   

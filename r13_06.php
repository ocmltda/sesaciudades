...
<br>
      ...
      <table width="100%" border="0" cellspacing="10" cellpadding="10">
        <tr>
          ...
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/outletbebe.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo5.php','outbebe','menubar=yes,scrollbars=yes,resizable=yes,width=240,height=400')"></a></td>
        </tr>
        <tr>
          ...
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/lacasa-delbebé.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo89.php','bebecasa','menubar=yes,scrollbars=yes,resizable=yes,width=240,height=400')"></a></td>
        </tr>
        <tr>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/manzanitabebé.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo90.php','manzanita','menubar=yes,scrollbars=yes,resizable=yes,width=240,height=400')"></a></td>
      ...
      <br />
 <script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/cupones/r13/bebe"></script>      

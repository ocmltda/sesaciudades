      ...
      <table width="693" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td bgcolor="#FFFFFF" style="padding:10px;"><!-- InstanceBeginEditable name="Contenido" -->
            ...
            <p class="texto">Por favor seleccione:</p>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center"><img src="img/socios.jpg" width="366" height="82" border="0" usemap="#Map5">
                  <map name="Map5">
                    <area shape="rect" coords="20,15,162,60" href="corporativo.php">
                    <area shape="rect" coords="202,14,353,66" href="socio.php">
                </map></td>
              </tr>
            </table>
            <p>&nbsp;</p>
...
<p></p>
      <p class="txt"><br />
      </p><script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/haztesocio"></script>
<!-- InstanceEndEditable -->
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>

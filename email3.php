...
$sub="CONTACTO BENEFICIOS CHILE";

$mensaje=":: CONTACTO BENEFICIOS CHILE " . chr(13). chr(10);


$mensaje=$mensaje . "Asunto: " . $_POST[subject]        . chr(13). chr(10);

$mensaje=$mensaje . "Nombre: " . $_POST[nombre]        . chr(13). chr(10);

$mensaje=$mensaje . "Sexo: "  . $_POST[sexo]        . chr(13). chr(10);

$mensaje=$mensaje . "Telefono: " . $_POST[telefono]        . chr(13). chr(10);
...
$mensaje=$mensaje . "Comentarios: " . $_POST[text]      . chr(13). chr(10);
      ...
      mail("info@beneficioschile.cl, gvillarino@sesa.cl, mvillarino@ecrgroup.cl", $sub, $mensaje, $headers);

...
<br>
      ...
      <table width="100%" border="0" cellspacing="10" cellpadding="10">
        <tr>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/biblioviva.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo30.php','promo30','menubar=yes,scrollbars=yes,resizable=yes,width=310,height=410')"></a></td>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/libre-altamira.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo20.php','alta','menubar=yes,scrollbars=yes,resizable=yes,width=240,height=400')"></a></td>
        ...
        <tr>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/manpower.jpg" width="140" height="115" border="0" onClick="MM_openBrWindow('promo44.php','manpower','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=350')"></a></td>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/language.jpg" width="140" height="115" border="0" onClick="MM_openBrWindow('promo54.php','language','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=350')"></a></td>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/liteco.jpg" width="140" height="115" border="0" onClick="MM_openBrWindow('promo55.php','liteco','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=350')"></a></td>
        </tr>
        <tr>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/granjaeducativa.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo65.php','granja','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=400')"></a></td>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/instKennedy.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo66.php','kennedy','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=400')"></a></td>
      ...
      <br />
       <script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/cupones/r13/educacion"></script>

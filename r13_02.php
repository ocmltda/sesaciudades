...
<br>
      ...
      <table width="100%" border="0" cellspacing="10" cellpadding="10">
        <tr>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/siglo21deportes.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo8.php','siglo','menubar=yes,scrollbars=yes,resizable=yes,width=240,height=400')"></a></td>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/ata.jpg" width="140" height="115" border="0" onClick="MM_openBrWindow('promo15.php','ata','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=350')"></a></td>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/geoaventura.jpg" width="140" height="115" border="0" onClick="MM_openBrWindow('promo16.php','geob','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=350')"></a></td>
        </tr>
        <tr>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/pandora.jpg" width="140" height="115" border="0" onClick="MM_openBrWindow('promo17.php','pandora','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=350')"></a></td>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/juanmena.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo67.php','juanitomena','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=400')"></a></td>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/pacificClub.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('img/cupones/PacificClub.html','pacific','menubar=yes,scrollbars=yes,resizable=yes,width=650,height=350')"></a></td>
        </tr>
        <tr>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/sportLife.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('img/cupones/SportLife.html','sportlife','menubar=yes,scrollbars=yes,resizable=yes,width=650,height=350')"></a></td>
          <td align="center" valign="middle"><a href="#"><img src="img/cupones/bartoli.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo94.php','bartoli','menubar=yes,scrollbars=yes,resizable=yes,width=240,height=500')"></a></td>
...
<script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/cupones/r13/deporte"></script>

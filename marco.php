...
<br>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><p class="titulosNuestraClinica">SOLICITA TU CREDITO EN SOLUCI&Oacute;N<br>
            ...
            <p class="titulosNuestraClinica">MARCO LEGAL</p>
            <p align="justify" class="texto"><br>
              En el Diario oficial de 05 de Diciembre de 2011 se public&oacute;&nbsp;la Ley&nbsp;20.555, del Ministerio de Econom&iacute;a, Fomento y Turismo, que modifica&nbsp;la Ley&nbsp;19.496, sobre protecci&oacute;n de los derechos de los consumidores, para dotar de atribuciones en materias financieras, entre otras, al Servicio Nacional del Consumidor.</p>
            <p align="justify">&nbsp;</p>
            <p><span class="texto">El Cr&eacute;dito de Consumo que otorga Soluci&oacute;n S.A. se rige por la Ley 4.808, art. 1.526 N&ordm; 4 y 1.528, del C&oacute;digo Civil y la Ley 18.010, art. 10: Para las Operaciones de Cr&eacute;dito de Dinero.
  &nbsp;
            </span><br>
            </p>
            <p> <a href="referencia.php">Referencias</a>
            </p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p class="texto">&iexcl;<span class="titulosNuestraClinica">CARACTERISTICAS DEL PRODUCTO</span></p>
            <p>&nbsp;</p>
            <p class="texto">Las caracter&iacute;sticas son las siguientes:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
            <p class="texto">&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cr&eacute;dito a tasa fija denominado en pesos.</p>
            <p class="texto">&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cr&eacute;dito destinado a personas naturales.</p>
            <p class="texto">&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Monto hasta $&nbsp;5.000.000 (*).</p>
            <p class="texto">&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Otorgados a Trabajadores de ECR Group y Empresas relacionadas&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
            <p class="texto">&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Plazos de&nbsp;6 a&nbsp;48 meses. (*)</p>
            <p class="texto">&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;De libre disponibilidad.</p>
            <p class="texto">&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sin seguros asociados.</p>
            <p class="texto">&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Refinanciamiento del cr&eacute;dito en cualquier momento.</p>
            <p class="texto">&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pago de cuotas mediante descuento por planilla.</p>
            <p class="texto">(*) Nota: Montos y Plazos sujetos a evaluaci&oacute;n particular de cada solicitud.</p>
            <br>
  <br></td>
        </tr>
        </table>
  ...
  <script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/marcolegal"></script>

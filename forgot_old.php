...
<br>
    ...
    <td align="left" valign="top" bgcolor="#B54515"  style="padding-left:15px;">
      ...
      <map name="Map2" id="Map2">
        <area shape="rect" coords="360,117,538,152" href="a1.html" />
          </map>
        <span class="tituloPresupuesto"><br>
        </span><?php
	  /******************** ERROR MESSAGES*************************************************
	  This code is to show error messages 
	  **************************************************************************/
	if(!empty($err))  {
      ...
      <form action="forgot.php" method="post" name="actForm" id="actForm" >
        <table width="65%" border="0" align="center" cellpadding="4" cellspacing="4" class="form">
          <tr> 
            <td colspan="2" class="titulosNuestraClinica2">Recordar contrase&ntilde;a<br>
            <em><span class="txt">Escriba su direcci&oacute;n de correo y le enviaremos una nueva contrase&ntilde;a </span></em></td>
          </tr>
          <tr> 
            <td width="36%" class="titulosNuestraClinica">Email:</td>
            <td width="64%"><input name="user_email" type="text" class="required email" id="txtboxn" size="25"></td>
          </tr>
          <tr>
            <td width="36%" class="titulosNuestraClinica">Rut:</td>
            <td><input name="rut" type="text" class="required email" id="txtboxn2" size="25"></td>
          </tr>
          <tr> 
            <td colspan="2"> <div align="center"> 
                <p> 
                  <input name="doReset" type="submit" id="doLogin3" value="Enviar">
                </p>
              </div></td>
          </tr>
        </table>
...
<!--
    ...
    tagCertifica( 25780, '/home/beneficios/recordarcontrasena');

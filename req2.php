      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><p class="titulosNuestraClinica">SOLICITA TU CREDITO EN SOLUCI&Oacute;N<br>
            ...
            <p></p>
            <p> <br>
              <span class="titulosNuestraClinica">REQUISITOS y DOCUMENTOS NECESARIOS  PARA CONSTITUIR Y ALZAR PRENDAS DE VEHICULOS</span><br>
              <br>
              <span class="texto">Certificado de Anotaciones Vigentes del veh&iacute;culo.<br>
              Padr&oacute;n del Veh&iacute;culo o Inscripci&oacute;n en el R.N.V.M.<br>
              Fotocopia de Cedula de Identidad del Propietario.<br>
              Certificado de Matrimonio (r&eacute;gimen conyugal).<br>
              Firma de Escritura P&uacute;blica (Prenda sin Desplazamiento sobre Veh&iacute;culo Motorizado).<br>
              Los costos de constituci&oacute;n y de alzamiento de prendas son de cargo del cliente. Debe enterarlos a Soluci&oacute;n antes de su constituci&oacute;n. Los gastos asociados,  son por Notario; Abogado; Inscripci&oacute;n</span></p>

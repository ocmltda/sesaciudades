      ...
      <table width="693" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td bgcolor="#FFFFFF" style="padding:10px;"><!-- InstanceBeginEditable name="Contenido" -->
            <p><span class="titulosNuestraClinica2">Hazte Socio</span><br>
            </p>
            <p class="titulosNuestraClinica">Socios Corporativos</p>
            <p>&nbsp;</p>
            <p class="texto">AUN NO TE INSCRIBES, HAZLO HOY; LLAMANOS AL 02-2225-0576, &nbsp;o&nbsp;env&iacute;anos tus datos a&nbsp;<a href="mailto:info@beneficioschile.cl" target="_blank">info@beneficioschile.cl</a></p>
            <p>&nbsp;</p>
            <p class="texto">P&iacute;dele a tu&nbsp;empresa que se asocie a Beneficios Chile S.A. y disfruta de todos los convenios&nbsp; y servicios, donde encontraras todo lo que necesitas, con rebajas, descuentos y promociones, con mejores precios y mil&nbsp; formas de pago.</p>
            <p>&nbsp;</p>
            <p class="texto"><br />
</p>
<p></p>
      <p class="txt"><br />
      </p><script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/haztesocio/corporativo"></script>
<!-- InstanceEndEditable -->
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>

...
<br>
    ...
    <td align="left" valign="top" bgcolor="#B54515"  style="padding-left:15px;">
      ...
      <p><!-- #BeginLibraryItem "/Library/r5.lbi" -->
<span class="titulosNuestraClinica2">Regi&oacute;n de Valparaíso</span><!-- #EndLibraryItem --><br>
...
<!-- #EndLibraryItem --></p>
      <table width="100%" border="0" cellspacing="10" cellpadding="10">
        <tr>
          <td width="33%" height="138" align="center" valign="middle"><a href="#"><img src="img/cupones/pacificClub.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('img/cupones/PacificClub.html','pacific','menubar=yes,scrollbars=yes,resizable=yes,width=650,height=350')"></a></td>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/sportLife.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('img/cupones/SportLife.html','sportlife','menubar=yes,scrollbars=yes,resizable=yes,width=650,height=350')"></a></td>
      ...
      <br />
      <script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/cupones/r5/deporte"></script> 

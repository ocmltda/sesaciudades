...
<br>
    ...
    <td align="left" valign="top" bgcolor="#B54515"  style="padding-left:15px;">
      ...
      <div id="contactform">
        <?php
	$sub= "Sugerencias desde web Club de Beneficios chp.cl";
    $headers = "From: $email";
      $message .= "
	SUGERENCIAS
	 
	 Mas Cupones      	: 	$cupones
	 Que cupones     	: 	$cupontxt
	 Nuevas promociones	: 	$promociones
	 Que Promociones	: 	$promotxt
	 Nuevos Servicios	: 	$servicios
	 Que Servicios		: 	$servtxt
	 Articulos			: 	$articulos
	 Que Servicios		: 	$articulotxt
	 Email				: 	$email
	 ...
	 _________________________________________________________________________________________________
	    ";
    $message2 .= "
      Gracias por enviar sus sugerencias con el Asunto: $sub.\n
      Para tu referencia, se ha incorporado el texto original del mensaje al final de este correo.\n
      Tu mensaje original era
      $text
    ";
      $headers2 .= "From: chp@chp.cl\n";
      $sub2.="Re: $sub";
    ?>
        <h2 class="style10 Estilo2">Gracias!</h2>
        <p class="txt">Tu mensaje ha sido enviado, usando la siguiente direcci&oacute;n de correo electr&oacute;nico </p>
        <p class="style10 Estilo2"><span style="font-weight:bold;"><?php print $email; ?></span></p>
        <p class="style10 Estilo2">
          <script type='text/javascript'>ocument.write('<a href="javascript:history.go(-1);">vuelve atras</a>');
                            </script>
          <span class="texto">Si no es correcto,
          <script type='text/javascript'>ocument.write('<a href="javascript:history.go(-1);">vuelve atras</a>');
                            </script>
          vuelve atr&aacute;s y envialo nuevamente. </span></p>
      ...
      mail("rquezada@sesa.cl, gvillarino@sesa.cl", $sub, $message, $headers);

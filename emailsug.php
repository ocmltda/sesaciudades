...
$sub="Sugerencias Convenio desde BENEFICIOS CHILE";

$mensaje=":: Sugerencias Convenio desde BENEFICIOS CHILE " . chr(13). chr(10);
...
$mensaje=$mensaje . "Empresa: " . $_POST[empresa]        . chr(13). chr(10);

$mensaje=$mensaje . "Rubro: " . $_POST[rubro]        . chr(13). chr(10);
...
$sub2="Sugerencias Convenio desde BENEFICIOS CHILE " . chr(13). chr(10);

$mensaje2= "Estimado Socio / a  $_POST[nombre] 
Muchas gracias por tu participación. Haremos nuestro mejor esfuerzo para conseguir tu convenio.
Saludos Cordiales 
Beneficios Chile
...
?>
      ...
      <h2 class="titulosNuestraClinica2">Gracias!<br>
      </h2>
      <p class="texto"><span class="titulosNuestraClinica">TU SOLICITUD HA SIDO ENVIADA CON EXITO. AGRADECEMOS TU APORTE. ESPERAMOS LOGRAR TU REQUERIMIENTO.</span><br>

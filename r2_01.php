...
<br><!-- #BeginLibraryItem "/Library/Untitled.lbi" -->
<span class="titulosNuestraClinica2">Cupones de Descuento</span><br>
...
<!-- #EndLibraryItem --></p>
      <table width="100%" border="0" cellspacing="10" cellpadding="10">
        <tr>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/casahelena.jpg" width="140" height="115" border="0" onClick="MM_openBrWindow('promo53.php','casahelena','menubar=yes,scrollbars=yes,resizable=yes,width=230,height=350')"></a></td>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/panales-tintin.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo70.php','tintin','menubar=yes,scrollbars=yes,resizable=yes,width=315,height=580')"></a></td>
          <td width="33%" align="center" valign="middle"><a href="#"><img src="img/cupones/viauno.jpg" width="140" height="116" border="0" onClick="MM_openBrWindow('promo73.php','viauno','menubar=yes,scrollbars=yes,resizable=yes,width=240,height=400')"></a></td>
        </tr>
        <tr>
      ...
      <br />
       <script src="http://b.scorecardresearch.com/c2/6906501/cs.js#sitio_id=235524&path=/home/cupones/r2/vestuario"></script>

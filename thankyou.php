...
<br>
    ...
    <td align="left" valign="top" bgcolor="#B54515"  style="padding-left:15px;">
      ...
      <h4 class="titulosNuestraClinica2">Su registro se ha completado exitosamente...<br>
      </h4>
      <p class="txt"><font size="2" face="Arial, Helvetica, sans-serif">Un correo electr&oacute;nico 
        ha sido enviado a su  email, con los detalles de su registro</font><br>
      </p>
      <p class="txt"><font size="2" face="Arial, Helvetica, sans-serif">Por favor revise su correo </font></p>
      <p></p>
      <map name="Map5" id="Map5">
        <area shape="rect" coords="364,115,537,146" href="f7.html" />
      </map>
        <br />
    <!-- InstanceEndEditable -->
            <table width="100%" border="0" cellspacing="0" cellpadding="0">

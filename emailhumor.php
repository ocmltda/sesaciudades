...
$sub="HUMOR BENEFICIOS CHILE";

$mensaje=":: HUMOR BENEFICIOS CHILE " . chr(13). chr(10);
...
$mensaje=$mensaje . "Chiste" . chr(13). chr(13). chr(10);
$mensaje=$mensaje . "--------------------------------------------------------------------" . chr(13). chr(13). chr(10);

$mensaje=$mensaje . "Chiste: " . $_POST[text]      . chr(13). chr(10);
}
...
?>
      ...
      <p class="titulosNuestraClinica2">&nbsp;AGRADECEMOS TU PARTICIPACI&Oacute;N&nbsp;</p>
      <p>&nbsp;</p>
      <p class="texto">NOTA : Los chistes enviados ser&aacute;n evaluados antes de subir, por lo tanto, no pueden atentar contra la buenas costumbres.<span class="texto">&nbsp;&nbsp;Si tu chiste no aparece, se debe a que no cumpli&oacute; las condiciones indicadas</span>.</p>
<h2 class="titulosNuestraClinica2">&nbsp;</h2>
